        ...
        <div class="tab-content">
          <div class="tab-pane fade show active" id="tab-description" role="tabpanel"
            ...
            <div class="product-single__description">
               <H3 class="product-single__title">{{$product->name}}</h3>
          </div>
...
<form name="addtocart-form" method="POST" action="{{route('cart.add')}}">
    ...
    <input type="hidden" name="quantity" value="1" />
        ...
        <input type="hidden" name="price" value="{{$rproduct->sale_price == '' ? $rproduct->regular_price:$product->sale_price}}" />                        
                <button type="submit"
...
<div class="container mt-5 pt-4">
    ...
    <div class="mb-4">
        <div class="d-flex align-items-center">
            <span class="fs-1 fw-bold me-3">{{ number_format($product->avgRating(), 1) }}</span>
            <div>
