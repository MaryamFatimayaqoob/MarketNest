...
@section('content')
 <main class="pt-90">
        ...
        <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
            ...
            <div class="accordion-body px-0 pb-0 pt-3">
                <div class="category-list">
                    @php
                        $selectedCategories = $f_categories ? explode(',', $f_categories) : [];
                    @endphp
                    @foreach ($categories as $category)
                        <div class="form-check mb-2">
                            ...
                            <span class="float-end text-muted small">({{ $category->products()->count() }})</span>
                        </div>
                    @endforeach
                </div>
            </div>
                ...
                <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
                    ...
                    <div class="accordion-body px-0 pb-0">
                        <div class="brand-list">
                            @php
                                $selectedBrands = $f_brands ? explode(',', $f_brands) : [];
                            @endphp
                            @foreach ($brands as $brand)
                                <div class="form-check mb-2">
                                    ...
                                    <span class="float-end text-muted small">({{ $brand->products->count() }})</span>
                                </div>
                            @endforeach
                        </div>
                    </div>
      ...
      <div class="shop-list flex-grow-1">
          ...
          <div class="swiper-wrapper">
              ...
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                ...
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="assets/images/shop/abc.png" width="630" height="450"
            ...
            <div class="swiper-slide">
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                ...
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="assets/images/shop/CDE.jpg" width="630" height="450"
                      alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                ...
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="{{ asset('assets/images/shop/efg.jpg')}}" width="630" height="450"
                      alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            <form id="frmFilter" method="GET" action="{{ route('shop.index') }}" class="d-flex gap-2">
    <select class="shop-acs__select form-select w-auto border-0 py-0" id="sorting" name="sorting" style="margin-right:10px;">
        ...
        <option value="price" {{ $sorting == 'price' ? 'selected' : '' }}>Price: low to high</option>
        <option value="price-desc" {{ $sorting == 'price-desc' ? 'selected' : '' }}>Price: high to low</option>
    </select>
    
    <select class="shop-acs__select form-select w-auto border-0 py-0" id="pagesize" name="size" style="margin-left:10px;">
        ...
        <option value="96" {{ $size == '96' ? 'selected' : '' }}>Show 96</option>
    </select>
    
    <!-- Hidden field for brands -->
    ...
    <input type="hidden" name="categories" id="hdnCategories" value="{{ $f_categories }}">
            ...
            <div class="shop-asc__seprator mx-3 bg-light d-none d-md-block"></div>
...
<script>
    ...
    let brandCheckboxes = document.querySelectorAll('.chk-brand');
    brandCheckboxes.forEach(function(checkbox) {
        checkbox.addEventListener('change', function() {
            ...
            document.getElementById('hdnBrands').value = brands.join(',');
            document.getElementById('frmFilter').submit();
        });
    });
    

    let categoryCheckboxes = document.querySelectorAll('.chk-category');
    categoryCheckboxes.forEach(function(checkbox) {
        checkbox.addEventListener('change', function() {
            ...
            document.getElementById('hdnCategories').value = categories.join(',');
            document.getElementById('frmFilter').submit();
        });
    });
</script>
