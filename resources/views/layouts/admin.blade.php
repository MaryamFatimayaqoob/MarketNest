                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt="" src="{{ asset('mages/logo/logo.png') }}"
                                        data-light="{{ asset('images/logo/logo.png') }}" data-dark="{{ asset('mages/logo/logo.png') }}"
                                        ...
                                        <ul class="">
                                            ...
                                            <li>
                                                <ul>
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('mages/products/21.png') }}" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="product-list.html" class="body-text">Maryam
                                                                    Fatima</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                        ...
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    <span class="body-title mb-2">Maryam Fatima</span>
                    ...
                    <div class="main-content">
                       @yield('content')
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2026 MarketNest</div>
                        </div>
                    </div>
