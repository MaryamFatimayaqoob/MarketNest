    ...
    <section class="my-account container">
        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="pname">
                                        <div class="image">
                                            <img src="{{ asset('uploads/products/thumbnails') }}/{{ $orderitem->product->image ?? 'default.jpg' }}" alt="" class="image">
                                        </div>
                                        <div class="name">
                                            <a href="{{ route('shop.product.details', ['product_slug' => $orderitem->product->slug ?? '']) }}" target="_blank" class="body-title-2">{{ $orderitem->product->name ?? $orderitem->product_name }}</a>                                    
                                        </div>  
                                    </td>
                                    ...
                                    <td class="text-center">{{ $orderitem->options ?? 'N/A' }}</td>
                ...
                <!-- Cancel Order Button - Shows for 'ordered' status regardless of transaction -->
